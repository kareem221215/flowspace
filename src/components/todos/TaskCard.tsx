    ...
    >
      ...
      <div className="flex items-center gap-1.5 mb-2.5 flex-wrap">
        ...
        {todo.labels?.map((label) => (
          <span key={label} className="badge bg-slate-100 text-slate-500">
            {label}
          </span>
        ))}
      </div>
      ...
      <p
        className={cn(
          'text-sm font-medium text-slate-800 leading-snug mb-3',
      ...
      <div className="flex items-center gap-2">
        ...
        {assignee ? (
          ...
          <div
            className="w-6 h-6 rounded-full border-2 border-dashed border-slate-200 flex items-center justify-center shrink-0"
            title="Unassigned"
          />
        )}
        ...
        <div className="ml-auto relative">
          <button
            ...
            className="p-1 rounded opacity-0 group-hover:opacity-100 transition-opacity text-slate-400 hover:text-slate-600 hover:bg-slate-100"
          >
